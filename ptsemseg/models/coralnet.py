...
class coralnet(nn.Module):
    ...
    def __init__(self, resnet='resnet101', feature_scale=4, n_classes=9, pretrained=True, is_deconv=True, in_channels=4, is_batchnorm=True):
        ...
        weights = models.resnet101(pretrained=False)
        ...
        # Encoder
        self.convbnrelu1 = conv2DBatchNormRelu(in_channels=self.in_channels, k_size=7, n_filters=64, padding=3, stride=2, bias=False)
